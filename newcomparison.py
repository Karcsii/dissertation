...
for name in test:
    ...
    labels = df.applymap(lambda x: latex_float(x))
    ...
    print(ax1.collections[0].colorbar.ax.yaxis.get_offset_text().get_text())
    ...
    print(ax2.collections[0].colorbar.ax.yaxis.get_offset_text().get_text())
    ...
    fig.savefig('./newcomparison/{name}_throughputnumber.png'.format(name=name))
    plt.clf()
    ...
    fig.savefig('./newcomparison/{name}_latency.png'.format(name=name))
    plt.clf()
    ...
    fig.savefig('./newcomparison/{name}_iops.png'.format(name=name))
    plt.clf()
    ...
    exponent = ax1.collections[0].colorbar.ax.yaxis.get_offset_text().get_text()
    ax1.collections[0].colorbar.set_ticklabels([latex_num(x, exponent) for x in labels])
    ax1.collections[0].colorbar.set_label("Average PSU Power (W)")
    ax1.set_ylabel("Parallel Tasks")
    ax1.set_xlabel("Block Size")
    ax1.invert_yaxis()
    ax1.set_title('SSD')
    ...
    exponent = ax2.collections[0].colorbar.ax.yaxis.get_offset_text().get_text()
    ax2.collections[0].colorbar.set_ticklabels([latex_num(x, exponent) for x in labels])
    ax2.collections[0].colorbar.set_label("Average PSU Power (W)")
    ax2.set_ylabel("Parallel Tasks")
    ax2.set_xlabel("Block Size")
    ax2.invert_yaxis()
    ax2.set_title('HDD')

    fig.savefig('./newcomparison/{name}_powertotal.png'.format(name=name))
    plt.clf()

    fig, (ax1, ax2) = plt.subplots(1, 2)
    fig.set_size_inches([12.8, 4.8])

    labels = dfssdssd.applymap(lambda x: latex_float(x))
    ...
    exponent = ax1.collections[0].colorbar.ax.yaxis.get_offset_text().get_text()
    ax1.collections[0].colorbar.set_ticklabels([latex_num(x, exponent) for x in labels])
    ax1.collections[0].colorbar.set_label("Average SSD Power (W)")
    ax1.set_ylabel("Parallel Tasks")
    ax1.set_xlabel("Block Size")
    ax1.invert_yaxis()
    ax1.set_title('SSD')
    ...
    labels = dfhddhdd.applymap(lambda x: latex_float(x))
    ...
    exponent = ax2.collections[0].colorbar.ax.yaxis.get_offset_text().get_text()
    ax2.collections[0].colorbar.set_ticklabels([latex_num(x, exponent) for x in labels])
    ax2.collections[0].colorbar.set_label("Average HDD Power (W)")
    ax2.set_ylabel("Parallel Tasks")
    ax2.set_xlabel("Block Size")
    ax2.invert_yaxis()
    ax2.set_title('HDD')

    fig.savefig('./newcomparison/{name}_powerdrive.png'.format(name=name))
    plt.clf()

    fig, (ax1, ax2) = plt.subplots(1, 2)
    fig.set_size_inches([12.8, 4.8])

    labels = dfmemoryssd.applymap(lambda x: latex_float(x))
    ...
    exponent = ax1.collections[0].colorbar.ax.yaxis.get_offset_text().get_text()
    ax1.collections[0].colorbar.set_ticklabels([latex_num(x, exponent) for x in labels])
    ax1.collections[0].colorbar.set_label("Average Memory Power (W)")
    ax1.set_ylabel("Parallel Tasks")
    ax1.set_xlabel("Block Size")
    ax1.invert_yaxis()
    ax1.set_title('SSD')
    ...
    labels = dfmemoryhdd.applymap(lambda x: latex_float(x))
    ...
    exponent = ax2.collections[0].colorbar.ax.yaxis.get_offset_text().get_text()
    ax2.collections[0].colorbar.set_ticklabels([latex_num(x, exponent) for x in labels])
    ax2.collections[0].colorbar.set_label("Average Memory Power (W)")
    ax2.set_ylabel("Parallel Tasks")
    ax2.set_xlabel("Block Size")
    ax2.invert_yaxis()
    ax2.set_title('HDD')

    fig.savefig('./newcomparison/{name}_powermemory.png'.format(name=name))
    plt.clf()
    # power SSD
